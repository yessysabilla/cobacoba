...
<html>
<head>
	<center><title>Formulir Penerima BANSOS</title></center>
</head>
<style>
...
<body>
	<header>
		<h1>Formulir Edit Penerima</h1>
	</header>
	
	<form action="proseseditanggota.php" method="POST">
		...
		<p>
			<label for="sekolah_asal">Asal kecamatan: </label>
			<input type="text" name="asal_sekolah" placeholder="Nama Asal kecamatan" value="<?php echo $anggota['asal_sekolah'] ?>" />
		</p>
		<p>
